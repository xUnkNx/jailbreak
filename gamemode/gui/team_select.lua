...
function createtmmn()
	...
	function teambut:Paint(w, h)
		...
		surface.SetTextPos(w * .5-surface.GetTextSize("Охранники") * .5,h * .8)
		surface.DrawText("Охранники")
	end
	...
	function teambut2:Paint(w, h)
		...
		surface.SetFont("JBHUDFONTBOLD")
		surface.SetTextColor(color_white)
		surface.SetTextPos(w * .5-surface.GetTextSize("Заключённые") * .5,h * .8)
		surface.DrawText("Заключённые")
	end
	...
	if LocalPlayer():IsAdmin() then
		...
		function teambut3:Paint(w, h)
			...
			surface.SetFont("JBHUDFONTBOLD")
			surface.SetTextColor(color_white)
			surface.SetTextPos(w * .5-surface.GetTextSize("Призраки") * .5,h * .8)
			surface.DrawText("Призраки")
		end
	...
	function teambut4:Paint(w,h)
		...
		surface.SetFont("JBHUDFONTBOLD")
		surface.SetTextColor(color_white)
		surface.SetTextPos(w * .5-surface.GetTextSize("Закрыть") * .5,h * .2)
